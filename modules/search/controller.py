...
from .services.search import format_graph, dfs_in_ram, bfs_in_ram, dfs_in_mysql, bfs_in_mysql
import time
...
async def depth_first_search_ram(start: int, end: int):
    ...
    traversal_path = await dfs_in_ram(formated_graph, start, end, traversal_path)
